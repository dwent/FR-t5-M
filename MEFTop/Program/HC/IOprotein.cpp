...
******************************************************************************/
void PDB::ReadName(char* PDBfile, string name[], string datalist)
{
	char buf[100];
	int i,j=0;
...
******************************************************************************/
void PDB::ReadCoord(char* PDBfile, double coordinate[], string datalist)
{
	char buf[100];
	int i,j=0;
	int ti=0;
...
******************************************************************************/
void PDB::ReadSerial(char* PDBfile, int serial[], string datalist)
{
	char buf[100];
	int i,j=0;
	int ti=0;
